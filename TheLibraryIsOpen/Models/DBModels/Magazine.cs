...
namespace TheLibraryIsOpen.Models.DBModels
{
    public class Magazine
    {
        ...
        */
        public Magazine(string title, string publisher, string language, DateTime date, string isbn10, string isbn13)
        {
            Title = title;
            Publisher = publisher;
            Language = language;
        ...
        public Magazine(int mgId, string title, string publisher, string language, DateTime date, string isbn10, string isbn13)
        {
            MagazineId = mgId;
            Title = title;
            Publisher = publisher;
